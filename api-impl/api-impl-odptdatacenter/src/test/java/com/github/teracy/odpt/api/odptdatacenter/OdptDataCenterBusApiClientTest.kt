...
/**
 * 公共交通オープンデータセンターバスAPI向けクライアント実装のテスト
 */
@RunWith(Enclosed::class)
class OdptDataCenterBusApiClientTest {
    /**
     * 公共交通オープンデータセンターバスAPI向けクライアント実装テスト基底クラス
     */
    abstract class BusClientTest : ApiClientTest {
        lateinit var consumerKey: String
        lateinit var okHttpClient: OkHttpClient
        lateinit var apiClient: OdptDataCenterBusApiClient
        ...
        fun setUp() {
            ...
            apiClient = OdptDataCenterBusApiClient(okHttpClient, consumerKey)
        }
