...
/**
 * 東京公共交通オープンデータチャレンジ鉄道API向けクライアント実装
 *
 * @param okHttpClient OKHttpClientインスタンス
 * @param consumerKey APIアクセス用のアクセストークン
 */
class TokyoChallengeTrainApiClient @Inject constructor(
    private val okHttpClient: OkHttpClient,
    private val consumerKey: String
) : TokyoChallengeApiClient, TrainDataPointApiClient, TrainPlaceApiClient {
